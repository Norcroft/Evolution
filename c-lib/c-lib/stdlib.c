...
int __rand()     /* This is the ANSI suggested portable code */
{
...
void (*_exitvector[EXIT_LIMIT])(void);
int _number_of_exit_functions;

void _exit_init()
{
    _number_of_exit_functions = 0;
}

int atexit(void (*func)(void))
{
    if (_number_of_exit_functions >= EXIT_LIMIT) return 1;    /* failure */
    _exitvector[_number_of_exit_functions++] = func;
    return 0;                                                /* success */
}
