...
/*
 * RCS $Revision: 1.51 $
 * Checkin $Date: 1995/10/30 12:35:13 $
...
extern List* cur_loperand_types;
...
extern Binder *class_has_ctor(TagBinder *b, bool is_null_ptr_const, TypeExpr *t, int pick_best);
...
extern Symstr *ovld_template_app(Symstr *sv, FormTypeList *f, ExprList *a);
...
#define mkfnap_cpp(e, l, curried, let) (e)
...
#define ovld_resolve(b, alternatives, l, ll) 0
