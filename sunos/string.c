...
#ifndef __ARM
#define PLUS_APRM 1          /* So that C coded memcpy etc included */
#endif
...
void *_memset(void *a, const char b, size_t n)
/* Used by compiler for structure assignments */
{
  char *wa = a;
  while (n != 0) *wa++ = b, n--;
...
/* all this does at the moment is a strcmp */
{
    return strcmp(a, b);
}
...
{   const unsigned char *t = s;
    while (n-- > 0) if (*t == (unsigned char)ch) return (void *)t; else t++;
    return 0;
}
