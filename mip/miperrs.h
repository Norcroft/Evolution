...
/*
 * RCS $Revision: 1.43 $ Codemist 151
 * Checkin $Date: 1995/11/01 11:57:54 $
...
#define warn_option_r "unknown option -r%c: ignored"
#define warn_option_f "unknown option -f%c: ignored"
#define warn_option_g "unknown debugging option -g%c: -g assumed"
#define warn_option_e "unknown option -e%c: ignored"
#define warn_option_w "unknown option -w%c: ignored"
...
#define bind_warn_unused_this_in_member "'this' unused in class member function"
...
#define driver_incompat_options "Incompatible options: '%s'.\n"
...
#define driver_inconsistent_EM "Warning: %s -E/M %s - inconsistent options\n"
...
#define syserr_ldrk "duff LDRK %lx"
#define syserr_ldrbk "duff LDRBK %lx"
#define syserr_ldrwk "duff LDRWK %lx"
