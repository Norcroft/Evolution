 ...
 * Copyright (C) Codemist Ltd., 1988-1994.
 * Copyright (C) Acorn Computers Ltd., 1988.
 */

/*
 * RCS $Revision: 1.9 $  Codemist 11a
 * Checkin $Date: 93/10/07 17:37:17 $
...
#endif
/* WATCOM C defines MSDOS, Microsoft C MSDOS and _MSDOS ...             */
/* Note it is beter to test __DOS__ than __WATCOM__ (host vs. compiler) */
#ifdef MSDOS
