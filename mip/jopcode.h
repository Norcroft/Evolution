...
#define    J_STRWVK     38L
           with_bits("STRWVK", _jm(MEM_W)+_J_STACKREF+_J_IVD+_J_READ_R1)
...
#define    J_ADCONF     101L     /* only if SOFTWARE_FLOATING_POINT */
           with_bits("ADCONF", _J_MEMA+_J_SET_R1)
#define    J_ADCOND     102L     /* only if SOFTWARE_FLOATING_POINT */
           with_bits("ADCOND", _J_MEMA+_J_SET_R1)
