/*
 * mips/mcerrs.h - prototype for machine-specific error messages file
 */
...
#define syserr_log2 "log2(%lx)"
#define syserr_add_int "mips_add_int"
#define syserr_silly_shift "Silly rshift value %ld"
...
#define syserr_outinstr2 "outinstr(%lx,%lx)"
#define syserr_illegal_jopmode "Illegal JOP mode(%lx,%lx)"
#define syserr_remove_fpnop "remove_noops(MOVD/FR r,r) failed"
#define syserr_decode_external "decode_external"
#define syserr_debug_addr "local_fpaddress"

/* end of mips/mcerrs.h */
